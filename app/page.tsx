...
const HERO_QUOTES = [
  ...
  "the sun came up before any of you noticed.",
  "you missed the last train and didn’t even care.",
  "the goodbye took three hours.",
  "you were the last two awake, still talking.",
  "you talked over each other telling the same story.",
  "someone started crying from laughing too hard.",
  "someone said ‘don’t forget this’ and you never did.",
  "you laughed at something only the two of you understood.",
  "the food was gone but nobody left the table.",
  "everyone crammed into one tiny room and it was perfect.",
  "you split one dessert four ways and fought over the last bite.",
  "it was nobody’s birthday and it still felt like a celebration.",
  "you danced in the kitchen for no reason at all.",
  "someone put on that one song and the whole room lost it.",
  "you made a plan at 2am and actually went through with it.",
  "you almost didn’t go, and it became the best night.",
  "it started raining and you stayed out in it anyway.",
  "the first snow fell and you all ran outside.",
  "that summer felt like it would never end.",
  "you drove around with no destination and the windows down.",
  "you took the long way home on purpose.",
  "the whole day happened by accident.",
  "you woke up somewhere unexpected and grinning.",
  "you hadn’t seen each other in years and it didn’t matter.",
  "you all showed up without really planning to.",
  "someone found the old photos and the night disappeared.",
  "the photo came out blurry and you kept it anyway.",
  "the power went out and nobody reached for their phone.",
  "you raised a glass and couldn’t find the words.",
] as const
    ...
    <div className={cn('min-h-screen bg-rw-bg overflow-x-hidden', isAuthed && 'pb-20 md:pb-0')}>
      ...
      <footer className="bg-rw-bg border-t border-rw-border px-6 sm:px-10 py-7 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <p className="text-[12px] text-rw-text-placeholder">
          © 2026 Remember When <span aria-hidden="true">·</span> Created by{' '}
          <a
